...
#import "UIGestureRecognizer+YZHState.m"
...
-(void)addTapGestureRecognizerBlock:(YZHGestureRecognizerBlock)gestureBlock;
-(void)addDoubleTapGestureRecognizerBlock:(YZHGestureRecognizerBlock)gestureBlock;
-(void)addPanGestureRecognizerBlock:(YZHGestureRecognizerBlock)gestureBlock;
//这里长按只会调用一次的YZHIntervalGestureRecognizerActionOptionsOnlyOnce，如果没有特别指点系统的那种options的话，长按只会调用一次。
-(void)addLongPressGestureRecognizerBlock:(YZHGestureRecognizerBlock)gestureBlock;
//这里长按只会调用一次的YZHIntervalGestureRecognizerActionOptionsOnlyEnd，如果没有特别指点系统的那种options的话，长按只会调用一次。
-(void)addLongPressGestureRecognizerBlockOnlyEnd:(YZHGestureRecognizerBlock)gestureBlock;

-(void)addTapGestureRecognizerBlock:(YZHGestureRecognizerBlock)gestureBlock shouldBeginBlock:(YZHGestureRecognizerShouldBeginBlock)shouldBeginBlock;
-(void)addDoubleTapGestureRecognizerBlock:(YZHGestureRecognizerBlock)gestureBlock shouldBeginBlock:(YZHGestureRecognizerShouldBeginBlock)shouldBeginBlock;
-(void)addPanGestureRecognizerBlock:(YZHGestureRecognizerBlock)gestureBlock shouldBeginBlock:(YZHGestureRecognizerShouldBeginBlock)shouldBeginBlock;
-(void)addLongPressGestureRecognizerBlock:(YZHGestureRecognizerBlock)gestureBlock shouldBeginBlock:(YZHGestureRecognizerShouldBeginBlock)shouldBeginBlock;

-(void)addPanGestureRecognizerBlock:(YZHGestureRecognizerBlock)gestureBlock actionOptionsInfo:(YZHIntervalGestureRecognizerActionOptionsInfo*)optionsInfo;
-(void)addLongPressGestureRecognizerBlock:(YZHGestureRecognizerBlock)gestureBlock actionOptionsInfo:(YZHIntervalGestureRecognizerActionOptionsInfo*)optionsInfo;

-(void)addPanGestureRecognizerBlock:(YZHGestureRecognizerBlock)gestureBlock shouldBeginBlock:(YZHGestureRecognizerShouldBeginBlock)shouldBeginBlock actionOptionsInfo:(YZHIntervalGestureRecognizerActionOptionsInfo*)optionsInfo;
-(void)addLongPressGestureRecognizerBlock:(YZHGestureRecognizerBlock)gestureBlock shouldBeginBlock:(YZHGestureRecognizerShouldBeginBlock)shouldBeginBlock actionOptionsInfo:(YZHIntervalGestureRecognizerActionOptionsInfo*)optionsInfo;

//-(void)printActionTargest;
@end
